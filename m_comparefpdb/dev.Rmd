---
title: "DB Comparison for Regression Test"
author: "Fuheng"
date: "August 31, 2016"
output:
  pdf_document:
...
Algo 1 - Read all from binary dump into data structure(slow):

```
$./m_comparefpdb.ibm.tsk -m HFDB_BINARY -c db_compare_config -l /ts/pod/px/px100/backup/hf100db_bindump -r /ts/pod/px/px100/backup/hf100db_bindump_new -p 100
Ignoring following fields in comparison: id,pricing_id,position_id,security_id,objid_1,objid_2,objid_3,fmdb33_exists,fmdb39_exists,pos_flags,deal_id,dept,subflag,db_status,has_umtm_px,fmdb30_bb_unique_id,id,pricing_id,position_id,security_id,objid_1,objid_2,objid_3,fmdb33_exists,fmdb39_exists,pos_flags,deal_id,dept,subflag,db_status,has_umtm_px,fmdb30_bb_unique_id,can_pool_partial_ppy_assumption,can_pool_refinance_rate,fmdb30_icoc_secinc,faskpx,faskyld,fbidpx,fbidyld,frisk2,frisk4
Adding field tomspos.open_pos to the list of comparison fields, values to be compared with epsilon 0.001, zero values will be compared.
Adding field tomspos.pos to the list of comparison fields, values to be compared with epsilon 0.001, zero values will be compared.
Reconstituting database dump from /ts/pod/px/px100/backup/hf100db_bindump.tomspos
TODO
Reconstituting database dump from /ts/pod/px/px100/backup/hf100db_bindump.pricing
TODO
Reconstituting database dump from /ts/pod/px/px100/backup/hf100db_bindump.mop
TODO
Reconstituting database dump from /ts/pod/px/px100/backup/hf100db_bindump.fx
TODO
Reconstituting database dump from /ts/pod/px/px100/backup/hf100db_bindump.fx2
TODO
Reconstituting database dump from /ts/pod/px/px100/backup/hf100db_bindump.fx3
TODO
Reconstituting database dump from /ts/pod/px/px100/backup/hf100db_bindump.tws_strategy
TODO
Reconstituting database dump from /ts/pod/px/px100/backup/hf100db_bindump_new.tomspos
TODO
Reconstituting database dump from /ts/pod/px/px100/backup/hf100db_bindump_new.pricing
TODO
Reconstituting database dump from /ts/pod/px/px100/backup/hf100db_bindump_new.mop
TODO
Reconstituting database dump from /ts/pod/px/px100/backup/hf100db_bindump_new.fx
TODO
Reconstituting database dump from /ts/pod/px/px100/backup/hf100db_bindump_new.fx2
TODO
Reconstituting database dump from /ts/pod/px/px100/backup/hf100db_bindump_new.fx3
TODO
Reconstituting database dump from /ts/pod/px/px100/backup/hf100db_bindump_new.tws_strategy
TODO
Total number or records in left source:
Pricing: 0
Position: 0
...
Nasdaq_mmpr: 0
Tws_strategy: 0
Data comparison concluded, two sources are identical in terms of compared fields.
```
